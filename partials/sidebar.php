...
<ul class="accordion-container navbar-nav sidebar-list">
  ...
  <ul class="description navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link content-link" href="dashboard.php?cat=admin&subcat=index">Downloads</a>
      </li>
        <li class="nav-item">
        <a class="nav-link content-link" href="dashboard.php?cat=admin&subcat=ratings">Ratings</a>
      </li>
        <li class="nav-item">
        <a class="nav-link content-link" href="dashboard.php?cat=admin&subcat=demo">Demographics</a>
      </li>

			  ...
			  <div class="form-group">
            	...
            	<select class="form-control" name="content_section">
                   ...
                   switch (strtolower($contentSection)) {
            		...
            		<option value="about fordacommute">About FordaCommute</option>
            		<option value="fordacommute features">FordaCommute Features</option>
            		<option value="fordacommute descriptions">FordaCommute Descriptions</option>
                          
                          <?php 
                          break;
                          case 'about fordacommute':
                          ?>
                    <option value="how to download" >How to Download</option>
            		<option value="about fordacommute" selected>About FordaCommute</option>
            		<option value="fordacommute features">FordaCommute Features</option>
            		<option value="fordacommute descriptions">FordaCommute Descriptions</option>
                           <?php
                          break;
                          case 'fordacommute features':
                           ?>
                     <option value="how to download">How to Download</option>
            		<option value="about fordacommute">About FordaCommute</option>
            		<option value="fordacommute features" selected>FordaCommute Features</option>
            		<option value="fordacommute descriptions">FordaCommute Descriptions</option>
                           <?php
                          break;
                         case 'fordacommute description':
                           ?>
                     <option value="how to download">How to Download</option>
            		<option value="about fordacommute">About FordaCommute</option>
            		<option value="fordacommute features" >FordaCommute Features</option>
            		<option value="fordacommute descriptions" selected>FordaCommute Descriptions</option>
                           <?php    		
            		...
            		<option value="about fordacommute">About FordaCommute</option>
            		<option value="fordacommute features">FordaCommute Features</option>
            		<option value="fordacommute description">FordaCommute Descriptions</option>
            	<?php } ?>
            	</select>
            </div>
		</div>
